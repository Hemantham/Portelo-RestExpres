...
schedule);
  ...
  /**
   * <P>Encrypt a password given the cleartext password and a
"salt".</P>
   ...
   * @return A string consisting of the 2-character salt followed by
the
   * encrypted password.
   */
...
the
  ...
  public static final String crypt(String original)
  {
    ...
    salt = (new
StringBuffer()).append(saltChars[Math.abs(randomGenerator.nextInt()) %
numSaltChars]).append(saltChars[Math.abs(randomGenerator.nextInt()) %
numSaltChars]).toString();
   ...
   */
  public final static boolean matches(String encryptedPassword, String
enteredPassword)
  {
  ...
  public static void main(String[] args) {
	 String pwd = UnixCrypt.crypt("PE", "898241502111467222232010");
